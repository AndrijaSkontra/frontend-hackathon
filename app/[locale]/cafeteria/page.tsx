                    ...
                    <div className="p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                          ...
                          <p className="text-amber-800">{location.hours}</p>
                        </div>
                        <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                          <h3 className="font-medium mb-2 text-amber-900">
                            Cuisine Types
                          ...
                          <div className="flex flex-wrap gap-2">
                            {location.cuisineTypes.map((cuisine) => (
                              <span
                                key={cuisine}
                                className="bg-amber-100 px-2 py-1 rounded-full text-sm text-amber-800"
                              >
                                {cuisine}
                              </span>
                            ))}
                                      ...
                                      <div className="flex justify-between items-center">
                                        <div className="flex gap-1">
                                          {item.dietary.map((diet) => (
                                            <span
                                              key={diet}
                                              className="text-xs bg-amber-100 px-2 py-1 rounded-full text-amber-800"
                                            >
                                              {diet}
                                            </span>
                                          ))}
