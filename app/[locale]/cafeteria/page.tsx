...
const CAFETERIA_LOCATIONS = [
  {
    ...
    description: "The primary dining facility on campus with multiple food stations and seating areas.",
  ...
  },
  {
    ...
    description: "Quick grab-and-go options ideal for busy students between classes.",
  ...
  },
  {
    ...
    description: "Multiple food vendors offering various options in one central location.",
  ...
  },
  {
    id: "c4",
    name: "Library Café",
    description: "Quiet study-friendly café offering coffee, snacks, and light meals.",
  ...
  },
  {
    id: "c5",
    name: "The Quad Grill",
    description: "Outdoor seasonal grill with patio seating and popular comfort foods.",
  ...
  },
  {
    ...
    description: "Health-focused dining options catering to nutrition-conscious students.",
...
const MENU_ITEMS = {
  breakfast: [
    { name: "Scrambled Eggs", price: "$3.99", dietary: ["Vegetarian", "Gluten-Free"], calories: 240 },
    { name: "Pancakes", price: "$4.50", dietary: ["Vegetarian"], calories: 450 },
    { name: "Avocado Toast", price: "$5.99", dietary: ["Vegan", "Vegetarian"], calories: 320 },
    { name: "Breakfast Burrito", price: "$6.50", dietary: [], calories: 580 },
    { name: "Oatmeal with Fruit", price: "$3.50", dietary: ["Vegan", "Vegetarian", "Gluten-Free"], calories: 290 },
    { name: "Greek Yogurt Parfait", price: "$4.25", dietary: ["Vegetarian"], calories: 310 }
  ],
  lunch: [
    { name: "Grilled Chicken Sandwich", price: "$7.99", dietary: [], calories: 420 },
    { name: "Veggie Burger", price: "$6.99", dietary: ["Vegetarian"], calories: 380 },
    { name: "Caesar Salad", price: "$6.50", dietary: ["Vegetarian"], calories: 320 },
    { name: "Turkey Club Wrap", price: "$7.50", dietary: [], calories: 450 },
    { name: "Quinoa Bowl", price: "$8.25", dietary: ["Vegan", "Vegetarian", "Gluten-Free"], calories: 410 },
    { name: "Pasta Primavera", price: "$7.25", dietary: ["Vegetarian"], calories: 540 }
  ],
  dinner: [
    { name: "Grilled Salmon", price: "$12.99", dietary: ["Gluten-Free"], calories: 480 },
    { name: "Vegetable Stir Fry", price: "$9.99", dietary: ["Vegan", "Vegetarian"], calories: 350 },
    { name: "Steak with Roasted Potatoes", price: "$14.50", dietary: ["Gluten-Free"], calories: 720 },
    { name: "Eggplant Parmesan", price: "$10.99", dietary: ["Vegetarian"], calories: 590 },
    { name: "Chicken Alfredo", price: "$11.25", dietary: [], calories: 680 },
    { name: "Black Bean Burrito Bowl", price: "$8.99", dietary: ["Vegan", "Vegetarian", "Gluten-Free"], calories: 520 }
  ]
};
...
export default function CafeteriaPage() {
  ...
  const filteredLocations = CAFETERIA_LOCATIONS.filter(
        ...
        <div className="container mx-auto px-6 py-8">
          {selectedLocation ? (
            ...
            <div>
              ...
              {(() => {
                const location = CAFETERIA_LOCATIONS.find(l => l.id === selectedLocation);
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {location.cuisineTypes.map(cuisine => (
                              <span key={cuisine} className="bg-gray-200 px-2 py-1 rounded-full text-sm">
                                {cuisine}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          ...
                          <ul className="list-disc list-inside">
                            {location.specialOffers.map(offer => (
                              <li key={offer} className="text-sm">{offer}</li>
                            ))}
                          </ul>
                        </div>
                      </div>
                                    ...
                                    <div className="flex justify-between items-center">
                                      <div className="flex gap-1">
                                        {item.dietary.map(diet => (
                                          <span key={diet} className="text-xs bg-gray-100 px-2 py-1 rounded-full">
                                            {diet}
                                          </span>
                                        ))}
                                      </div>
